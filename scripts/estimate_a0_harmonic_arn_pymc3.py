...
This script uses a harmonic model plus an auto-regressive model
...
sitename = 'M2S2N2K1O1_na{}_AR{}_dt{}min'.format(number_annual_harmonics, arn, subsample)
...
trace, my_model, omega, dtime  = harmonic_fit_mcmc_arn(timein, X, frq_lt, arn=arn,\
                                                              basetime=basetime)
