...
#sbatch run-vkdv-singularity $STOCHASTICA0 slim-stoch_a0_data_rho $RHODATA 367 500
sbatch run-vkdv-singularity $STOCHASTICA0 slim-stoch_a0_clim_rho $RHOCLIM 367 500
#sbatch run-vkdv-singularity $HARMONICA0 slim-harmo_a0_data_rho $RHODATA 367 500
sbatch run-vkdv-singularity $HARMONICA0 slim-harmo_a0_clim_rho $RHOCLIM 367 500
